...
namespace AdressBook
{
    class AdressBook
    {
        ...
        public void Group()
        {
            ...
            {
                 FavGroup.Add(name11);
                Console.WriteLine("User added to Fav group ");
            }
            else if(ans == "2") 
            {
                GenGroup.Add(name11);
                Console.WriteLine("User added to Gen group ");
            }
            

        }
        public void show() {
            Console.WriteLine("Which group you want to access? Favourite Group -1 , general group - 2");
